...
function lz_cleaning_services_sanitize_checkbox( $input ) {
	return ( ( isset( $input ) && true == $input ) ? true : false );
}

function lz_cleaning_services_sanitize_phone_number( $phone ) {
	return preg_replace( '/[^\d+]/', '', $phone );
}

//footer Link
define('LZ_CLEANING_SERVICES_LIVE_DEMO',__('https://luzukdemo.com/demo/cleaning-services/','lz-cleaning-services'));
define('LZ_CLEANING_SERVICES_PRO_DOCS',__('https://luzukdemo.com/demo/cleaning-services/documentation/','lz-cleaning-services'));
define('LZ_CLEANING_SERVICES_BUY_NOW',__('https://www.luzuk.com/products/cleaning-services-wordpress-theme/','lz-cleaning-services'));
